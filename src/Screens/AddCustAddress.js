...
export const AddCustAddress = ({navigation}) => {
    ...
    if (
      ...
      axios
        ...
        .then(function (response) {
          console.log('add adrees respons', response);
          Alert.alert('Address Saved Succesfully');
  ...
  return (
    <View>
      <Appbar.Header style={{backgroundColor: 'white'}}>
        ...
        />
        <Appbar.Content style={{alignSelf: 'center'}} title="Add Address" />
      </Appbar.Header>
      <TextInputComponent
        label="Address"
        value={adres.address}
